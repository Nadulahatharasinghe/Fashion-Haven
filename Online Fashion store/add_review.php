...
if(isset($_POST['logout'])) {
    ...
    header("Location: index.php"); // after user log out re direct to the homepage index.php
    exit();
}
?>
<?php
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style\add_review.css">
...
<h1>Fashion Haven</h1>
    ...
    <div class="aaa">
        <a href="store.php"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>
    </div>


<h1 class="center" style="color: orange; font-size: 30px;">POST YOUR REVIEW</h1>
    ...
    <form action="review.php" method="POST" onsubmit="return addcomment()">
        ...
        <textarea name="Comment_over" rows="10" cols="50" placeholder="Type your review message"></textarea><br>
