...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style\store_payment.css">
    <!--icons-->
 ...
 <style>
    ...
    <h1>Fashion Haven Online Store - Checkout</h1>
    <div class="container">
        ...
        <div class="form-section">
            ...
            <div>
                <input type="checkbox" id="news-offers" checked>
        ...
        <div class="form-section">
            ...
            <!--Go to Payments-->
            <button type="button" class="btn-buy" onclick="window.location.href='store_order.php'">Go to Payments</button>
        </div>
    </div>
    <!-- Footer Section -->
    <footer class="footer">
