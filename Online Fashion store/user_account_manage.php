...
$sql = "SELECT * FROM users WHERE check_user = '2' AND '1'";
        ...
        <tbody>
            <?php if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='edit_user.php?id=".$row['id']."' class='btn-edit'><button class='btn'>Edit</button></a>
                            <a href='delete_user.php?id=".$row['id']."' class='btn-delete' onclick='return confirm(\"Are you sure?\");'><button class='btn'>Delete</button></a>
                          </td>";
                    echo "</tr>";
                }
            } else {
