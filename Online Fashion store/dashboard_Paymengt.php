...
<style>
    ...
    <div class="container">
        <h2>Employee Payment Structure for Online Fashion Store</h2>
        <div class="role">
            <h3>1. Sales Staff / Customer Service Representatives</h3>
            <ul>
                <br>
                <li>- Base Salary</li><br>
                <li>- Commission</li><br>
                <li>- Bonuses</li>
            </ul>
        </div>
        <div class="role">
            <h3>2. Marketing Team</h3>
            <ul>
                <br>
                <li>- Base Salary</li><br>
                <li>- Performance Bonuses</li><br>
                <li>- Profit Sharing</li>
            </ul>
        </div>
        <div class="role">
            <h3>3. Warehouse Staff / Fulfillment Center Employees</h3>
            <ul>
                <br>
                <li>- Hourly</li><br>
                <li>- Overtime Pay</li><br>
                <li>- Bonuses</li>
            </ul>
        </div>
        <div class="role">
            <h3>4. IT / Web Development Team</h3>
            <ul>
                <br>
                <li>- Base Salary</li><br>
                <li>- Project Bonuses</li><br>
                <li>- Stock Options</li>
            </ul>
        </div>
        <div class="role">
            <h3>5. Management / Executive Roles</h3>
            <ul>
                <br>
                <li>- Base Salary</li><br>
                <li>- Performance Bonuses</li><br>
        ...
        <div class="role">
            <h3>6. Other Benefits</h3>
            <ul>
                <br>
                <li>- Health Insurance</li><br>
                <li>- Retirement Plans</li><br>
                <li>- Paid Time Off</li><br>
